...
class evaluation:
	...
	def __init__(self, doc_id, link_pred_dict, gold_xml_dir, predicted_xml_dir): #label_dict
	...
	def eval(self):
		...
		# gold_xml_file = os.path.join(self.gold_xml_folder, str(self.document_id)+'.xml')
		# text=open(gold_xml_file).read()
